...
| `guidelink` | 15/15 đạt | Sổ tay đọc được TRƯỚC khi đăng nhập: link nằm trong khung đăng nhập, bấm mở đúng trang (15 mục, 10 ảnh) và trang đó không đòi đăng nhập; menu ⋯ cũng có mục sổ tay; `/huong-dan` được khai báo trong vercel.json; sổ tay không chứa email nhân sự thật |
...
| Sổ tay người dùng ở đâu, sửa thế nào | `docs/huong-dan-su-dung.README.md`; link cho người dùng: `/huong-dan` (rewrite trong `vercel.json`), link trên màn đăng nhập là `.login-guide` trong `index.html` |
